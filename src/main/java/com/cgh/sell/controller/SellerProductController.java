...
import com.cgh.sell.form.ProductForm;
...
public class SellerProductController {
     ...
     */
    @PostMapping("/save")
//    @CachePut(cacheNames = "product",key = "123") //每次访问都执行一次,返回的ModelAndView对象内容写进redis
    @CacheEvict(cacheNames = "product",key = "123")  //在访问方法之后清除缓存
